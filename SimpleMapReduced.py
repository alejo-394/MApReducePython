...
class SimpleMapReduce(object):
    ...
    def __init__(self, map_func, reduce_func, num_workers=None):
        """
        map_func: Función para asignar entradas a datos intermedios. Toma como
            argumento un valor de entrada y vuelve a tupla con la clave
            y un valor a ser reducido.
        
        reduce_func: Función para reducir la versión particionada de los datos intermedios 
          ...
          Establézcalo en None para no preocuparse por el resultado
    ...
    def __call__(self, inputs, chunksize=1):
        """
        Procesa las entradas a través del mapa y reduzce las funciones dadas.
        
        inputs
          Un iterable que contiene los datos de entrada para ser procesado.
        
        chunksize=1
          La porción de los datos de entrada a mano para cada trabajador. Esta
